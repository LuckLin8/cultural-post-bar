			...
			<div id="sidebar">
				<div id="sidebar-wrapper">
					...
					<div id="profile-links"> Hello,
						<a href="#" title="Edit your profile">admin</a>, you have
					...
					<ul id="main-nav">
						...
						<li>
							...
							<ul>
								<li>
									<a href="adShowAllUserAction">查看会员</a>
								</li>
								
								<li>
									<a  href="${pageContext.request.contextPath}/admin/admin/adminAddUser.jsp">添加会员</a>
								</li>
						...
						<li>
							<a href="#" class="nav-top-item">板块管理 </a>
							<ul>
								<li>
									<a href="adminShowBoardsAction">查看板块</a>
								</li>
								<li>
									<a href="${pageContext.request.contextPath}/admin/admin/adminAddBoard.jsp">添加板块</a>
								</li>
								
							</ul>
						</li>
						<li>
							<a href="#" class="nav-top-item">版主管理 </a>
							<ul>
								<li>
									<a href="getMosAction">查看版主</a>
								</li>
								<li>
									<a href="toAddMoPageAction">添加版主</a>
								</li>
							</ul>
						</li>
						<li>
							<a href="#" class="nav-top-item"> 帖子管理 </a>
							<ul>
								<li>
									<a href="showAllPostAction">查看帖子</a>
								</li>
							</ul>
						</li>
						</s:if>
					...
					<div id="messages" style="display: none">
						...
						<form action="adminAddMessageAction" method="post">
							<h4>New Message</h4>
							<fieldset>
