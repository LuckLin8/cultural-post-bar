...
<meta name="viewport" content="width=device-width, initial-scale=1" charset="utf-8">
		...
		<link href="${pageContext.request.contextPath}/client/css/style2.css" rel='stylesheet' type='text/css' />
		...
		<img src="images/avtar.png" />
			...
			<s:form action="completeRegAction" theme="simple" enctype="multipart/form-data">
				...
				<div style=" color: #9199aa;font-size: 18px;font-weight: 100;">
					<span style=" color: #9199aa;font-size: 18px;font-weight: 100;float: left;margin-left:120px;">性&nbsp;&nbsp;&nbsp;别:</span><span style="margin-left:-130px"><s:radio style="margin-left:10px" class="text" list="#{'1':'男','0':'女'}" name="sex" value="1"/></span>
				</div>
